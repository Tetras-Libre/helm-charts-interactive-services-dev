...
![Version: 2.3.51](https://img.shields.io/badge/Version-2.3.51-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| route.resources.limits.cpu | string | `"15000m"` |  |
| route.resources.limits.memory | string | `"30Gi"` |  |
| route.resources.requests.cpu | string | `"2000m"` |  |
| route.resources.requests.memory | string | `"4Gi"` |  |
...
| service.image.custom.version | string | `"inseefrlab/onyxia-jupyter-tensorflow:py3.12.11-gpu"` |  |
| service.image.pullPolicy | string | `"Always"` |  |
| service.image.version | string | `"inseefrlab/onyxia-jupyter-tensorflow:py3.12.11-gpu"` |  |
